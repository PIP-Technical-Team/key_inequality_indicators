...
vrs <- 
  qs::qread(file = fs::path("data", 
                            "vrs.qs"))
pop <- 
  fst::read.fst(fs::path("data", 
                         "pop.fst"), 
                as.data.table = TRUE)
dt_pip <- 
  fst::read.fst(fs::path("data", 
...
#       ifelse(
#         input$color_by == "Region", dt_use_sp$region_name, dt_use_sp$incgroup
#       ), 
#       "Other"
#     )
#   )
...
<p style='text-align:justify;'>Please cite the data as:  World Bank. (`r stringr::str_sub(vrs[1], 1, 4)`). Poverty and Inequality Platform (version `r vrs[1]`) [Data set]. World Bank Group. www.pip.worldbank.org. Accessed `r today()`. </p>
