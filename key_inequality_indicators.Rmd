...
dt_use_sp <- reactive({
  ...
  if(input$allcountries == TRUE){
      dt_use_sp[
        region_code %chin% input$region_selected,
        Region := region_code
  ]
  }
# 
#   if(input$allcountries == FALSE){
#       dt_use_sp[
#         region_code %chin% input$region_selected,
#         Region := region_code
#   ]
#   }
  ...
  # if(!input$country_selected == ""){
  #     dt_use_sp[
  #       country_name %chin% input$countries_selected, 
  #       Region := region_code
  # ]
  # }
  # 
