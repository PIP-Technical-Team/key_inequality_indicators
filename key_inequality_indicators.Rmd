...
title_function <- function(ind){
  ...
  title_use_vec <- c(
    "Mean (daily per capita income or consumption 2017 PPP US$)", 
    "Median (daily per capita income or consumption 2017 PPP US$)", 
    "Gini index (0-100)",
    "MLD (mean log deviation)", 
    paste0("Decile", paste0(1:10, " welfare share (percent)")), 
    "Ratio of top 10 to bottom 40 welfare share", 
    "Ratio of top 20 to bottom 20 welfare share"
  )
